# Gog-Grenfell MultiStrain Model with Mutation, No Coinfection and Waning
...
def PCI_Mut_nocoinf_waning(x, t, parms):
    '''
    ...
    dSdt = mu - np.sum(beta * I * S) - np.matmul(sigma, beta * I) * S - mu * S + np.sum(gamma * I) - gamma * I + omega * R
